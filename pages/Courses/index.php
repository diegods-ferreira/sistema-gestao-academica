...
<body class="bg-light">
      ...
      <div class="row mt-5">
        <div class="col-10">
            ...
            <div class="row mb-3">
              <div class="col">
                <div class="alert alert-success alert-dismissible fade show" role="alert">
                  <?= $_GET['success'] === 'course-created' ? 'Curso criado com sucesso!' : '' ?>
                  <?= $_GET['success'] === 'course-updated' ? 'Curso editado com sucesso!' : '' ?>
                  <?= $_GET['success'] === 'course-deleted' ? 'Curso excluído com sucesso!' : '' ?>
          ...
          <div class="d-flex align-items-center justify-content-between">
            ...
            <button class="btn btn-success" data-toggle="modal" data-target="#createCourseModal">
          ...
          <?php
            $report = isset($_GET['report']) ? $_GET['report'] : 'courses-list';
            require_once "../../reports/courses/$report.php";
          ?>
        </div>

        <!-- CoursesReportsList component import -->
        <?php require_once '../../components/courses/CoursesReportsList.php' ?>
      </div>
    </div>
  </div>
  ...
  <!-- Create Course Modal -->
  <?php require_once '../../components/courses/CreateCourseModal.php' ?>

  <!-- Edit Course Modal -->
  <?php require_once '../../components/courses/EditCourseModal.php' ?>

  <!-- Detail Course Modal -->
  <?php require_once '../../components/courses/DetailCourseModal.php' ?>

  <!-- Delete Course Confirmation Modal -->
  <?php require_once '../../components/courses/DeleteCourseModal.php' ?>
